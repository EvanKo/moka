...
class EnterprisePayController extends BaseController
{
    ...
    private $mch_appid = "wx95eaefe010f7c7e8";//微信公众号appid,微信分配的公众账号ID（企业号corpid即为此appId）
    private $mchid = "1410843402";//商户ID，微信支付分配的商户号
    private $nonce_str = "";//随机字符串，不长于32位
    private $sign = ""; //签名在send时生成
    private $partner_trade_no = "";//商户订单号
    private $openid ="o85Ojws087WUmNZ8n3BO3ixbJH9A";//接收方的openID  
    ...
    private $spbill_create_ip="120.77.57.178";//调用接口的机器Ip地址,即脚本文件所在的IP

    private $key="didavtmer168didavtmer168didavtme";//商户支付密钥
